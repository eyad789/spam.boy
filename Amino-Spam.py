...
# -*-coding: utf-8 -*
#Red="\[\033[0;31m\]" # Red
#Green="\[\033[0;32m\]" # Green #Yellow="\[\033[0;33m\]" # Yellow
#Blue="\[\033[0;34m\]" # Blue #Purple="\[\033[0;35m\]" # Purple
#Cyan="\[\033[0;36m\]" # Cyan
...
#URed="\[\033[4;31m\]" # Red
#UGreen="\[\033[4;32m\]" # Green #UYellow="\[\033[4;33m\]" # Yellow
...
if i == "1" :
 ...
 try:
 subclient.send_message(message=message,messageType=55,chatId=chatId)
 except:
...
if i == '3' :
 ...
 client.login(email=mail, password=p)
 subclient =
 amino.SubClient(comId=comId,profile=client.profile)
